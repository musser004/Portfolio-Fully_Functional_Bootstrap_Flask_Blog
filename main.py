...
class BlogPost(db.Model):
    ...
    img_url = db.Column(db.String(750), nullable=False)
...
# Admin-only decorator (locking access to only the admin user)
...
# Loading user with login manager
